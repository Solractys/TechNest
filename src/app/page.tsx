...
export default function Home() {
  return (
    <main className="min-h-screen">
      ...
      <section className="bg-gradient-to-r from-primary-600 to-secondary-600 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <Link href="/events/create" className="btn bg-white text-primary-600 hover:bg-gray-100">
              Organizar um evento
            </Link>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {mockEvents.map((event) => (
              <Link href={`/events/${event.slug}`} key={event.id} className="card hover:shadow-lg transition-shadow duration-300">
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {['Frontend', 'Backend', 'DevOps', 'Data Science', 'Mobile', 'Cloud', 'Security', 'AI & ML'].map((category) => (
              <Link 
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">Faça parte da comunidade tech</h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto mb-8">
            Conecte-se com profissionais, aprenda com especialistas e fique por dentro 
            dos eventos mais relevantes da comunidade de tecnologia.
          </p>
