...
export default function SignUp() {
  ...
  const handleSubmit = useCallback(
    ...
    [name, email, password, passwordConfirm, router],
  );

  return (
    <div className="text-slate-700 flex min-h-[calc(100vh-64px)] flex-col justify-center py-12 sm:px-6 lg:px-8 bg-gray-50">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <Link
          href="/"
          className="-m-1.5 p-1.5 flex items-center justify-center"
        >
          <div className="h-10 w-10 bg-primary-600 rounded-md flex items-center justify-center mr-2">
            <svg
          ...
          <span className="text-primary-600 text-lg font-medium ml-1">
            .app
          </span>
        </Link>
        ...
        <div className="bg-white px-4 py-8 shadow sm:rounded-lg sm:px-10">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center">
              ...
              <div className="px-2 text-sm text-gray-500">Ou</div>
              <div className="w-full border-t border-gray-300"></div>
            </div>
