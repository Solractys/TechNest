...
export default function EditEventPage() {
      ...
      const fetchEventAndCategories = async () => {
        try {
          ...
          if (eventData.endDate) {
            ...
            setEndTime(
              eventEndDate.toISOString().split("T")[1].substring(0, 5),
            );
          }
  ...
  if (
    ...
    return (
      <div className="max-w-4xl mx-auto px-4 py-10 text-center text-slate-700">
          ...
          <div className="grid grid-cols-1 gap-6">
            ...
            <div className="border-t pt-4">
              ...
              <p className="mt-1 text-xs text-gray-500">
                Desmarque esta opção para salvar como rascunho (não visível para
                o público).
              </p>
            </div>
          </div>
