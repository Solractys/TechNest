  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-10">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Compartilhe seu evento com a comunidade tech em São Paulo</p>
      </div>
          ...
          <div className="grid grid-cols-1 gap-6">
            ...
            <div>
              ...
              {categoriesLoading ? (
                ...
                <p className="text-sm text-red-500 italic">Nenhuma categoria disponível. Entre em contato com o administrador.</p>
              ) : null}
            </div>
            ...
            <div className="border-t pt-4">
              <div className="flex items-center">
                <input
                  ...
                  className="focus:ring-primary-500 h-4 w-4 text-primary-600 border-gray-300 rounded"
                />
                <label htmlFor="publishNow" className="ml-2 block text-sm font-medium text-gray-700">
                  Publicar evento imediatamente
                </label>
              </div>
              <p className="mt-1 text-xs text-gray-500">
                Se desmarcado, o evento será salvo como rascunho e poderá ser publicado posteriormente.
              </p>
            </div>
          </div>
        </div>
